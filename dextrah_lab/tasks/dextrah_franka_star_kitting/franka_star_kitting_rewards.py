...
def compute_franka_star_kitting_rewards(
    ...
    lift_reward_start_height = 0.012
    ...
    finger_contact_gate = torch.clamp((0.055 - finger_center_to_star_dist) / 0.030, 0.0, 1.0)
    ...
    grasp_ready = finger_contact_gate * (0.20 + 0.80 * finger_near_star) * (0.25 + 0.75 * near_star)
    ...
    lift_reward = lift_weight * lift_progress * grasp_ready * (0.10 + 0.90 * closed_gripper)
    lift_action_reward = (
