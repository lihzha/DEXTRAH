...
def _collect_task_metrics(task_env, actions: torch.Tensor | None = None) -> dict[str, float | None]:
    metric_names = [
        ...
        "grasp_prior_reset_candidate_down_table_count",
        "grasp_prior_reset_candidate_down_table_width_count",
        "grasp_prior_reset_candidate_down_table_width_center_count",
        "grasp_prior_reset_candidate_down_table_width_center_contact_count",
        "grasp_prior_reset_candidate_down_table_width_center_contact_farther_count",
