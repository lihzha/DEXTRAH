...
if [ "$TASK" = "Dextrah-Franka-Multi-Object-Grasp" ] || [ "$TASK" = "Dextrah-Franka-Multi-Object-RGB-Grasp" ]; then
  DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_CLOSE_MAX_EE_ERROR="0.05"
  DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_EE_ERROR="0.05"
  DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_FINGER_CENTER_DIST="0.08"
