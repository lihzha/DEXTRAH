...
GRASP_PRIOR_RESET_MIN_PREGRASP_Z="${GRASP_PRIOR_RESET_MIN_PREGRASP_Z:-0.10}"
GRASP_PRIOR_RESET_MAX_CENTER_DISTANCE_FRAC="${GRASP_PRIOR_RESET_MAX_CENTER_DISTANCE_FRAC:-0.55}"
