...
DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_CLOSE_MAX_EE_ERROR="0.0"
DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_EE_ERROR="0.0"
DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_FINGER_CENTER_DIST="0.0"
DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_CLOSED_WIDTH_MARGIN="-1.0"
if [ "$TASK" = "Dextrah-Franka-Multi-Object-Grasp" ] || [ "$TASK" = "Dextrah-Franka-Multi-Object-RGB-Grasp" ]; then
  DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_CLOSE_MAX_EE_ERROR="0.0"
  DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_EE_ERROR="0.0"
  DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_FINGER_CENTER_DIST="0.0"
  DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_CLOSED_WIDTH_MARGIN="0.03"
fi
GRASP_PRIOR_ACTION_WARMSTART_CLOSE_MAX_EE_ERROR="${GRASP_PRIOR_ACTION_WARMSTART_CLOSE_MAX_EE_ERROR:-$DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_CLOSE_MAX_EE_ERROR}"
GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_EE_ERROR="${GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_EE_ERROR:-$DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_EE_ERROR}"
GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_FINGER_CENTER_DIST="${GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_FINGER_CENTER_DIST:-$DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_MAX_FINGER_CENTER_DIST}"
GRASP_PRIOR_ACTION_WARMSTART_LIFT_CLOSED_WIDTH_MARGIN="${GRASP_PRIOR_ACTION_WARMSTART_LIFT_CLOSED_WIDTH_MARGIN:-$DEFAULT_GRASP_PRIOR_ACTION_WARMSTART_LIFT_CLOSED_WIDTH_MARGIN}"
...
DEXTRAH_GRASP_PRIOR_BC_LOSS_ENABLED="${DEXTRAH_GRASP_PRIOR_BC_LOSS_ENABLED:-False}"
DEXTRAH_GRASP_PRIOR_BC_LOSS_WEIGHT="${DEXTRAH_GRASP_PRIOR_BC_LOSS_WEIGHT:-0.0}"
DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS="${DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS:-all}"
DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS_HYDRA="$DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS"
if [[ "$DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS_HYDRA" == *,* \
  && "$DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS_HYDRA" != \[*\] ]]; then
  DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS_HYDRA="[$DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS_HYDRA]"
fi
DEXTRAH_BC_POLICY_ANCHOR_ENABLED="${DEXTRAH_BC_POLICY_ANCHOR_ENABLED:-False}"
DEXTRAH_BC_POLICY_ANCHOR_WEIGHT="${DEXTRAH_BC_POLICY_ANCHOR_WEIGHT:-0.0}"
DEXTRAH_FREEZE_OBS_RMS_ENABLED="${DEXTRAH_FREEZE_OBS_RMS_ENABLED:-False}"
DEXTRAH_ACTOR_LOSS_SCALE="${DEXTRAH_ACTOR_LOSS_SCALE:-1.0}"
DEXTRAH_CRITIC_LOSS_SCALE="${DEXTRAH_CRITIC_LOSS_SCALE:-1.0}"
DEXTRAH_TRAINABLE_PARAM_SCOPE="${DEXTRAH_TRAINABLE_PARAM_SCOPE:-all}"
DEXTRAH_BOUNDS_LOSS_COEF="${DEXTRAH_BOUNDS_LOSS_COEF:-}"
...
case "$DEXTRAH_GRASP_PRIOR_BC_LOSS_ENABLED" in
  True|true|1|yes|Yes)
    case "$GRASP_PRIOR_ACTION_PRIOR_REWARD_ENABLED" in
      True|true|1|yes|Yes) ;;
      *)
        echo "DEXTRAH_GRASP_PRIOR_BC_LOSS_ENABLED=True requires GRASP_PRIOR_ACTION_PRIOR_REWARD_ENABLED=True" >&2
        exit 2
        ;;
    esac
    ;;
...
echo "DEXTRAH_GRASP_PRIOR_BC_LOSS_ENABLED=$DEXTRAH_GRASP_PRIOR_BC_LOSS_ENABLED"
echo "DEXTRAH_GRASP_PRIOR_BC_LOSS_WEIGHT=$DEXTRAH_GRASP_PRIOR_BC_LOSS_WEIGHT"
echo "DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS=$DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS"
echo "DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS_HYDRA=$DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS_HYDRA"
echo "DEXTRAH_BC_POLICY_ANCHOR_ENABLED=$DEXTRAH_BC_POLICY_ANCHOR_ENABLED"
echo "DEXTRAH_BC_POLICY_ANCHOR_WEIGHT=$DEXTRAH_BC_POLICY_ANCHOR_WEIGHT"
echo "DEXTRAH_FREEZE_OBS_RMS_ENABLED=$DEXTRAH_FREEZE_OBS_RMS_ENABLED"
echo "DEXTRAH_ACTOR_LOSS_SCALE=$DEXTRAH_ACTOR_LOSS_SCALE"
echo "DEXTRAH_CRITIC_LOSS_SCALE=$DEXTRAH_CRITIC_LOSS_SCALE"
echo "DEXTRAH_TRAINABLE_PARAM_SCOPE=$DEXTRAH_TRAINABLE_PARAM_SCOPE"
echo "DEXTRAH_BOUNDS_LOSS_COEF=$DEXTRAH_BOUNDS_LOSS_COEF"
...
PY
    ...
    if [ -n '$DEXTRAH_BOUNDS_LOSS_COEF' ]; then
      COMMON_AGENT_OVERRIDES+=(agent.params.config.bounds_loss_coef='$DEXTRAH_BOUNDS_LOSS_COEF')
    fi
    ...
    TRAIN_ARGS=(
      train.py \
        ...
        +agent.params.config.dextrah_grasp_prior_bc_loss_dims='$DEXTRAH_GRASP_PRIOR_BC_LOSS_DIMS_HYDRA' \
        +agent.params.config.dextrah_bc_policy_anchor_enabled='$DEXTRAH_BC_POLICY_ANCHOR_ENABLED' \
        +agent.params.config.dextrah_bc_policy_anchor_weight='$DEXTRAH_BC_POLICY_ANCHOR_WEIGHT' \
        +agent.params.config.dextrah_freeze_obs_rms_enabled='$DEXTRAH_FREEZE_OBS_RMS_ENABLED' \
        +agent.params.config.dextrah_actor_loss_scale='$DEXTRAH_ACTOR_LOSS_SCALE' \
        +agent.params.config.dextrah_critic_loss_scale='$DEXTRAH_CRITIC_LOSS_SCALE' \
        +agent.params.config.dextrah_trainable_param_scope='$DEXTRAH_TRAINABLE_PARAM_SCOPE' \
        \"\${CENTRAL_VALUE_AGENT_OVERRIDES[@]}\" \
        \"\${COMMON_AGENT_OVERRIDES[@]}\" \
        \"\${RGB_AGENT_OVERRIDES[@]}\" \
        \"\${TASK_OVERRIDES[@]}\"
