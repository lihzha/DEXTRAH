...
export GRASP_PRIOR_LIBRARY_ARG CHECKPOINTS CHECKPOINTS_CONTAINER DETERMINISTIC RENDER RENDER_RESETS RENDER_INTERVAL RENDER_CANDIDATES RENDER_CANDIDATES_ARG CANDIDATES CANDIDATES_ARG
...
echo "CANDIDATES_ARG=$CANDIDATES_ARG"
