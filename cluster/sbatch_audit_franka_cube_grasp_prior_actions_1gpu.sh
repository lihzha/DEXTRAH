...
CHECKPOINTS="${CHECKPOINTS:?Set CHECKPOINTS to comma-separated label=/container/path checkpoint pairs.}"
...
export TASK RUN_NAME NUM_ENVS NUM_RESETS HORIZON_STEPS SEED CUBE_SPAWN_XY_RANDOMIZATION
export GRASP_PRIOR_LIBRARY_ARG CHECKPOINTS CHECKPOINTS_CONTAINER DETERMINISTIC RENDER RENDER_RESETS RENDER_INTERVAL RENDER_CANDIDATES
