...
export BIMANUAL_REFERENCE_CONTACT_SIDE_MARGIN BIMANUAL_REFERENCE_GAIN BIMANUAL_REFERENCE_MAX_ACTION
export BIMANUAL_REFERENCE_LIFT_GAIN BIMANUAL_REFERENCE_LIFT_MAX_ACTION BIMANUAL_REFERENCE_LIFT_SQUEEZE_Y
