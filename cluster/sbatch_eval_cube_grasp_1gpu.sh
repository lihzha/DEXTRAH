...
VIDEO_NAME_PREFIX="${VIDEO_NAME_PREFIX:-cube-grasp-eval-overhead}"
PRINT_INTERVAL="${PRINT_INTERVAL:-20}"
CAPTURE_VIDEO="${CAPTURE_VIDEO:-True}"
USE_CUDA_GRAPH="${USE_CUDA_GRAPH:-False}"
SEED="${SEED:-42}"
CAMERA_EYE_X="${CAMERA_EYE_X:--0.55}"
CAMERA_EYE_Y="${CAMERA_EYE_Y:-0.10}"
CAMERA_EYE_Z="${CAMERA_EYE_Z:-1.45}"
CAMERA_TARGET_X="${CAMERA_TARGET_X:--0.55}"
CAMERA_TARGET_Y="${CAMERA_TARGET_Y:-0.10}"
CAMERA_TARGET_Z="${CAMERA_TARGET_Z:-0.25}"
