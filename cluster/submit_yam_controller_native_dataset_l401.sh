...
payload = {
    ...
    "dataset_drop_center_max_correction_m": float("$DATASET_DROP_CENTER_MAX_CORRECTION_M"),
    "dataset_drop_settle_max_steps": int("$DATASET_DROP_SETTLE_MAX_STEPS"),
    "dataset_drop_settle_position_tolerance_m": float("$DATASET_DROP_SETTLE_POSITION_TOLERANCE_M"),
