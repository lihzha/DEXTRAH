...
payload = {
    ...
    "recording_gate_fallback_pose_lookahead": int("$RECORDING_GATE_FALLBACK_POSE_LOOKAHEAD"),
    ...
    "ground_texture_dir": "$YAM_POLICY_GROUND_TEXTURE_DIR",
    "ground_texture_tiling_range": [float(value) for value in "$YAM_POLICY_GROUND_TEXTURE_TILING_RANGE".split()],
    "ground_texture_size": [float(value) for value in "$YAM_POLICY_GROUND_TEXTURE_SIZE".split()],
