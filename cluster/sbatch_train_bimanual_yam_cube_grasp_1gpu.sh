...
CUBE_APPROACH_SHARPNESS="${CUBE_APPROACH_SHARPNESS:-}"
CUBE_ENCLOSURE_WEIGHT="${CUBE_ENCLOSURE_WEIGHT:-}"
CUBE_ENCLOSURE_SHARPNESS="${CUBE_ENCLOSURE_SHARPNESS:-}"
...
CUBE_HEIGHT_TRACKING_SHARPNESS="${CUBE_HEIGHT_TRACKING_SHARPNESS:-}"
CUBE_XY_STABILITY_WEIGHT="${CUBE_XY_STABILITY_WEIGHT:-}"
CUBE_XY_STABILITY_SHARPNESS="${CUBE_XY_STABILITY_SHARPNESS:-}"
...
echo "CUBE_APPROACH_SHARPNESS=$CUBE_APPROACH_SHARPNESS"
echo "CUBE_ENCLOSURE_WEIGHT=$CUBE_ENCLOSURE_WEIGHT"
echo "CUBE_ENCLOSURE_SHARPNESS=$CUBE_ENCLOSURE_SHARPNESS"
...
echo "CUBE_HEIGHT_TRACKING_SHARPNESS=$CUBE_HEIGHT_TRACKING_SHARPNESS"
echo "CUBE_XY_STABILITY_WEIGHT=$CUBE_XY_STABILITY_WEIGHT"
echo "CUBE_XY_STABILITY_SHARPNESS=$CUBE_XY_STABILITY_SHARPNESS"
...
echo "CUBE_DENSITY=$CUBE_DENSITY"
echo "CUBE_STATIC_FRICTION=$CUBE_STATIC_FRICTION"
echo "CUBE_DYNAMIC_FRICTION=$CUBE_DYNAMIC_FRICTION"
...
export ENTROPY_COEF E_CLIP GRAD_NORM SIGMA_INIT_VAL TRAIN_SIGMA USE_CUDA_GRAPH SEED CUBE_SPAWN_XY_RANDOMIZATION
export DEXTRAH_RLGAMES_JSONL_METRICS AUTO_RESUME CHECKPOINT ENV_NAME PREPARE_YAM_ASSETS
export CUBE_APPROACH_WEIGHT CUBE_APPROACH_SHARPNESS CUBE_ENCLOSURE_WEIGHT CUBE_ENCLOSURE_SHARPNESS
export CUBE_SIDE_ALIGNMENT_WEIGHT CUBE_LIFT_WEIGHT CUBE_HEIGHT_TRACKING_WEIGHT CUBE_HEIGHT_TRACKING_SHARPNESS
export CUBE_XY_STABILITY_WEIGHT CUBE_XY_STABILITY_SHARPNESS CUBE_SUCCESS_BONUS_WEIGHT
...
export CUBE_SIZE CUBE_DENSITY CUBE_STATIC_FRICTION CUBE_DYNAMIC_FRICTION
export BIMANUAL_ACTION_PRIOR_REWARD_ENABLED BIMANUAL_ACTION_PRIOR_REWARD_WEIGHT
export BIMANUAL_ACTION_PRIOR_REWARD_SHARPNESS BIMANUAL_REFERENCE_GAIN BIMANUAL_REFERENCE_MAX_ACTION
export BIMANUAL_REFERENCE_LIFT_GAIN BIMANUAL_REFERENCE_LIFT_MAX_ACTION
...
srun \
  ...
  bash -lc '
    ...
    append_env_override cube_approach_sharpness "$CUBE_APPROACH_SHARPNESS"
    append_env_override cube_enclosure_weight "$CUBE_ENCLOSURE_WEIGHT"
    append_env_override cube_enclosure_sharpness "$CUBE_ENCLOSURE_SHARPNESS"
    ...
    append_env_override cube_height_tracking_sharpness "$CUBE_HEIGHT_TRACKING_SHARPNESS"
    append_env_override cube_xy_stability_weight "$CUBE_XY_STABILITY_WEIGHT"
    append_env_override cube_xy_stability_sharpness "$CUBE_XY_STABILITY_SHARPNESS"
