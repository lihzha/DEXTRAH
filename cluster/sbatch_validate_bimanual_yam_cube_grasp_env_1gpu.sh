...
LIFT_SQUEEZE_Y="${LIFT_SQUEEZE_Y:-0.0}"
LEFT_ROT_ACTION_X="${LEFT_ROT_ACTION_X:-0.0}"
LEFT_ROT_ACTION_Y="${LEFT_ROT_ACTION_Y:-0.0}"
LEFT_ROT_ACTION_Z="${LEFT_ROT_ACTION_Z:-0.0}"
RIGHT_ROT_ACTION_X="${RIGHT_ROT_ACTION_X:-0.0}"
RIGHT_ROT_ACTION_Y="${RIGHT_ROT_ACTION_Y:-0.0}"
RIGHT_ROT_ACTION_Z="${RIGHT_ROT_ACTION_Z:-0.0}"
...
export TASK RUN_NAME NUM_ENVS NUM_STEPS VIDEO_LENGTH LIFT_HEIGHT LIFT_SQUEEZE_Y CAPTURE_VIDEO PRINT_INTERVAL SEED
export LEFT_ROT_ACTION_X LEFT_ROT_ACTION_Y LEFT_ROT_ACTION_Z RIGHT_ROT_ACTION_X RIGHT_ROT_ACTION_Y RIGHT_ROT_ACTION_Z
...
echo "LIFT_SQUEEZE_Y=$LIFT_SQUEEZE_Y"
echo "LEFT_ROT_ACTION=[$LEFT_ROT_ACTION_X, $LEFT_ROT_ACTION_Y, $LEFT_ROT_ACTION_Z]"
echo "RIGHT_ROT_ACTION=[$RIGHT_ROT_ACTION_X, $RIGHT_ROT_ACTION_Y, $RIGHT_ROT_ACTION_Z]"
...
srun \
  ...
  bash -lc '
    ...
    VALIDATE_ARGS=(
      ...
      --lift_squeeze_y "$LIFT_SQUEEZE_Y"
      --left_rot_action "$LEFT_ROT_ACTION_X" "$LEFT_ROT_ACTION_Y" "$LEFT_ROT_ACTION_Z"
      --right_rot_action "$RIGHT_ROT_ACTION_X" "$RIGHT_ROT_ACTION_Y" "$RIGHT_ROT_ACTION_Z"
