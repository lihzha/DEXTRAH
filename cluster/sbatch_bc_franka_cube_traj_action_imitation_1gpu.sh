...
export TASK RUN_NAME NUM_ENVS COLLECTION_STEPS TRAIN_STEPS BATCH_SIZE LEARNING_RATE WEIGHT_DECAY VALIDATION_FRACTION LOSS_DIMS EVAL_INTERVAL USE_CUDA_GRAPH SEED COLLECTION_ACTION_SOURCE COLLECTION_TEACHER_ALPHA CUBE_SPAWN_XY_RANDOMIZATION TRAJECTORY_TRACKING_REFERENCE_PATH
