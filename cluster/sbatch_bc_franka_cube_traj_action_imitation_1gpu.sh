...
export TASK RUN_NAME NUM_ENVS COLLECTION_STEPS TRAIN_STEPS BATCH_SIZE LEARNING_RATE WEIGHT_DECAY VALIDATION_FRACTION LOSS_DIMS EVAL_INTERVAL USE_CUDA_GRAPH SEED COLLECTION_ACTION_SOURCE COLLECTION_TEACHER_ALPHA COLLECTION_TEACHER_ALPHAS REHEARSAL_DATASET_PATHS REHEARSAL_DATASET_NAMES SOURCE_BATCH_MODE SOURCE_LOSS_WEIGHTS BEST_SCORE_WEIGHTS EARLY_STOP_PATIENCE DISTILL_SOURCES DISTILL_LOSS_WEIGHT DISTILL_DIMS RESIDUAL_ADAPTER_ENABLED RESIDUAL_HIDDEN_DIM RESIDUAL_MAX_ACTION RESIDUAL_PRESERVE_SOURCES RESIDUAL_PRESERVE_WEIGHT RESIDUAL_L2_WEIGHT RESIDUAL_GATE_ENABLED RESIDUAL_GATE_HIDDEN_DIM RESIDUAL_GATE_BIAS_INIT RESIDUAL_CONTEXT_FEATURES SOURCE_PROBE_STEPS SOURCE_PROBE_LR CUBE_SPAWN_XY_RANDOMIZATION TRAJECTORY_TRACKING_REFERENCE_PATH
