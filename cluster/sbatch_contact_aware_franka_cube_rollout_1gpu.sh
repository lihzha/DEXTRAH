...
export VARIANTS VARIANT_COUNT ALIGN_STEPS CLOSE_STEPS CLOSE_GRIPPER_WIDTH CLOSE_GRIPPER_WIDTH_OFFSET MIN_FINGER_CUBE_SURFACE_MARGIN
export LIFT_STEPS LIFT_HEIGHT FINGER_GAIN CLIP_ACTIONS PRINT_INTERVAL
