...
CONTROLLER_TARGET_LOOKAHEAD="${CONTROLLER_TARGET_LOOKAHEAD:-1}"
CONTROLLER_TARGET_TOLERANCE="${CONTROLLER_TARGET_TOLERANCE:-0.015}"
CONTROLLER_TARGET_MAX_HOLD="${CONTROLLER_TARGET_MAX_HOLD:-16}"
...
export CONTROLLER_TARGET_LOOKAHEAD CONTROLLER_TARGET_TOLERANCE CONTROLLER_TARGET_MAX_HOLD
...
echo "CONTROLLER_TARGET_LOOKAHEAD=$CONTROLLER_TARGET_LOOKAHEAD"
echo "CONTROLLER_TARGET_TOLERANCE=$CONTROLLER_TARGET_TOLERANCE"
echo "CONTROLLER_TARGET_MAX_HOLD=$CONTROLLER_TARGET_MAX_HOLD"
echo "MODES=$MODES"
