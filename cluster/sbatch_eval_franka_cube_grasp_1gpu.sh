...
if { [ "$ACTION_SOURCE" = "policy" ] || [ "$ACTION_SOURCE" = "policy_reference_mix" ]; } && [ -z "$CHECKPOINT" ]; then
...
export TASK RUN_NAME NUM_ENVS NUM_STEPS VIDEO_LENGTH VIDEO_NAME_PREFIX PRINT_INTERVAL CAPTURE_VIDEO DETERMINISTIC ACTION_SOURCE REFERENCE_MIX_ALPHA USE_CUDA_GRAPH SEED CUBE_SPAWN_XY_RANDOMIZATION TRAJECTORY_TRACKING_REFERENCE_PATH
