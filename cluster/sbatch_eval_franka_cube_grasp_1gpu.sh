...
export TASK RUN_NAME NUM_ENVS NUM_STEPS VIDEO_LENGTH VIDEO_NAME_PREFIX PRINT_INTERVAL CAPTURE_VIDEO DETERMINISTIC ACTION_SOURCE REFERENCE_MIX_ALPHA HOLD_PHASE_START HOLD_TRIGGER_LIFT_HEIGHT HOLD_CONTACT_MAX_FINGER_DIST HOLD_LIFT_HEIGHT HOLD_TARGET_POLICY HOLD_GRIPPER_ACTION USE_CUDA_GRAPH SEED CUBE_SPAWN_XY_RANDOMIZATION TRAJECTORY_TRACKING_REFERENCE_PATH
