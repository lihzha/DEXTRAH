...
RECORDING_SELECT_REPLAYABLE_SUCCESS_PREFIX="${RECORDING_SELECT_REPLAYABLE_SUCCESS_PREFIX:-False}"
...
export BIN_DROP_CONTAINMENT_TOLERANCE_M
...
export YAM_POLICY_GROUND_TEXTURE_DIR YAM_POLICY_GROUND_TEXTURE_TILING_RANGE
...
echo "BIN_DROP_CONTAINMENT_TOLERANCE_M=$BIN_DROP_CONTAINMENT_TOLERANCE_M"
...
echo "RECORDING_SELECT_REPLAYABLE_SUCCESS_PREFIX=$RECORDING_SELECT_REPLAYABLE_SUCCESS_PREFIX"
...
echo "YAM_POLICY_GROUND_TEXTURE_DIR=$YAM_POLICY_GROUND_TEXTURE_DIR"
echo "YAM_POLICY_GROUND_TEXTURE_TILING_RANGE=$YAM_POLICY_GROUND_TEXTURE_TILING_RANGE"
...
srun \
  ...
  bash -lc '
    ...
    STOP_ON_BIN_DROP_SUCCESS_ARGS=(--stop_on_bin_drop_success)
    if [ "$STOP_ON_BIN_DROP_SUCCESS" != "True" ]; then
      STOP_ON_BIN_DROP_SUCCESS_ARGS=(--no-stop_on_bin_drop_success)
    fi
    ...
    RECORDING_PREFIX_ARGS=(--recording_select_replayable_success_prefix)
    if [ "$RECORDING_SELECT_REPLAYABLE_SUCCESS_PREFIX" != "True" ]; then
      RECORDING_PREFIX_ARGS=(--no-recording_select_replayable_success_prefix)
    fi
    ...
    CMD=(
      ...
      --bin_drop_containment_tolerance_m "$BIN_DROP_CONTAINMENT_TOLERANCE_M"
