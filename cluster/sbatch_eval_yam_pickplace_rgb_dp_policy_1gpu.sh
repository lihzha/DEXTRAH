...
DATASET_DROP_REFERENCE_INSET_M="${DATASET_DROP_REFERENCE_INSET_M:-0.025}"
DATASET_DROP_RELEASE_CLEARANCE_M="${DATASET_DROP_RELEASE_CLEARANCE_M:-0.015}"
DATASET_DROP_POSE_MAX_CORRECTION_M="${DATASET_DROP_POSE_MAX_CORRECTION_M:-0.005}"
DATASET_DROP_SETTLE_MAX_STEPS="${DATASET_DROP_SETTLE_MAX_STEPS:-120}"
