...
DATASET_DROP_CENTER_MAX_CORRECTION_M="${DATASET_DROP_CENTER_MAX_CORRECTION_M:-0.0025}"
DATASET_DROP_SETTLE_MAX_STEPS="${DATASET_DROP_SETTLE_MAX_STEPS:-60}"
DATASET_DROP_SETTLE_POSITION_TOLERANCE_M="${DATASET_DROP_SETTLE_POSITION_TOLERANCE_M:-0.01}"
DATASET_DROP_SETTLE_LINEAR_SPEED="${DATASET_DROP_SETTLE_LINEAR_SPEED:-0.05}"
...
INITIAL_RENDER_WARMUP_FRAMES="${INITIAL_RENDER_WARMUP_FRAMES:-0}"
...
export DATASET_PRECISION_LOOKAHEAD DATASET_OBJECT_FEEDBACK_GAIN
...
srun \
  ...
  bash -lc '
    ...
    CMD=(
      ...
      --dataset_drop_center_max_correction_m "$DATASET_DROP_CENTER_MAX_CORRECTION_M"
      --dataset_drop_settle_max_steps "$DATASET_DROP_SETTLE_MAX_STEPS"
      --dataset_drop_settle_position_tolerance_m "$DATASET_DROP_SETTLE_POSITION_TOLERANCE_M"
