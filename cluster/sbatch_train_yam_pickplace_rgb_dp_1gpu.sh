...
ROLLOUT_EVERY="${ROLLOUT_EVERY:-10}"
SEED="${SEED:-42}"
...
export BATCH_SIZE VAL_BATCH_SIZE USE_EMA TRAINING_DEVICE RESUME NUM_INFERENCE_STEPS
...
echo "BATCH_SIZE=$BATCH_SIZE VAL_BATCH_SIZE=$VAL_BATCH_SIZE USE_EMA=$USE_EMA"
