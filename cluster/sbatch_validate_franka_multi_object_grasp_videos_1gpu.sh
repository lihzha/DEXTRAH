...
export TASK RUN_NAME NUM_ENVS SEED OBJECT_ASSET_MANIFEST_PATH MAX_OBJECTS
export OBJECT_SPAWN_XY_RANDOMIZATION OBJECT_SPAWN_YAW_RANDOMIZATION_DEG RENDER_WARMUP_FRAMES
export RESET_CYCLES SETTLE_STEPS PERTURB_STEPS GRASP_STEPS GRASP_OBJECT_SETTLE_STEPS CAPTURE_INTERVAL GRASP_RESET_ATTEMPTS
