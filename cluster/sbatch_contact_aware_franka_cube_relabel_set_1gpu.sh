...
CLOSE_HOLD_REFERENCE="${CLOSE_HOLD_REFERENCE:-contact_anchor}"
...
CLOSE_GRIPPER_WIDTH="${CLOSE_GRIPPER_WIDTH:--1.0}"
CLOSE_GRIPPER_WIDTH_OFFSET="${CLOSE_GRIPPER_WIDTH_OFFSET:--0.002}"
MIN_FINGER_CUBE_SURFACE_MARGIN="${MIN_FINGER_CUBE_SURFACE_MARGIN:--0.006}"
...
GATE_MIN_FINGER_CUBE_SURFACE_MARGIN="${GATE_MIN_FINGER_CUBE_SURFACE_MARGIN:-$MIN_FINGER_CUBE_SURFACE_MARGIN}"
...
export VARIANT ORIENTATION_MODE ALIGN_STEPS CONTACT_ALIGN_STEPS CONTACT_ALIGN_REFERENCE CLOSE_HOLD_REFERENCE CONTACT_ALIGN_THRESHOLD
...
export CLOSE_STEPS CLOSE_GRIPPER_WIDTH CLOSE_GRIPPER_WIDTH_OFFSET MIN_FINGER_CUBE_SURFACE_MARGIN
export LIFT_STEPS LIFT_HEIGHT FINGER_GAIN CLIP_ACTIONS
...
export GATE_MIN_LIFT GATE_MAX_POSE_CLIP_FRACTION GATE_MAX_FINAL_EE_TO_CUBE GATE_MAX_FINAL_FINGER_TO_CUBE GATE_MIN_FINGER_CUBE_SURFACE_MARGIN
...
echo "ALIGN_STEPS=$ALIGN_STEPS CONTACT_ALIGN_STEPS=$CONTACT_ALIGN_STEPS CONTACT_ALIGN_REFERENCE=$CONTACT_ALIGN_REFERENCE CLOSE_HOLD_REFERENCE=$CLOSE_HOLD_REFERENCE CONTACT_ALIGN_THRESHOLD=$CONTACT_ALIGN_THRESHOLD"
...
echo "CLOSE_GRIPPER_WIDTH=$CLOSE_GRIPPER_WIDTH CLOSE_GRIPPER_WIDTH_OFFSET=$CLOSE_GRIPPER_WIDTH_OFFSET MIN_FINGER_CUBE_SURFACE_MARGIN=$MIN_FINGER_CUBE_SURFACE_MARGIN"
...
echo "GATE_MIN_FINGER_CUBE_SURFACE_MARGIN=$GATE_MIN_FINGER_CUBE_SURFACE_MARGIN"
  ...
  bash -lc '
    ...
    for spec in "${SPEC_LIST[@]}"; do
      ...
      CMD=(
        ...
        --close_hold_reference "$CLOSE_HOLD_REFERENCE"
        ...
        --close_gripper_width "$CLOSE_GRIPPER_WIDTH"
        --close_gripper_width_offset "$CLOSE_GRIPPER_WIDTH_OFFSET"
        --min_finger_cube_surface_margin "$MIN_FINGER_CUBE_SURFACE_MARGIN"
    ...
    AGG_CMD=(
      ...
      --min_finger_cube_surface_margin "$GATE_MIN_FINGER_CUBE_SURFACE_MARGIN"
    )
